...
describe("FloatingActionBar", () => {
  ...
  describe("Basic Rendering", () => {
    ...
    it("should render the minimal Generate button", async () => {
      render(
        <TestWrapper>
          <FloatingActionBar />
        </TestWrapper>
  ...
  describe("Generate Combo Button", () => {
    it("should add an image generation node when Generate is clicked", async () => {
      render(
        <TestWrapper>
          <FloatingActionBar />
        </TestWrapper>
  ...
  describe("Browse Models Button", () => {
    it("should keep the model browser out of the first navigation", async () => {
      render(
        <TestWrapper>
          <FloatingActionBar />
        </TestWrapper>
      ...
      await waitFor(() => {
        expect(screen.queryByTitle("Browse models")).not.toBeInTheDocument();
        expect(screen.queryByText("All models")).not.toBeInTheDocument();
      });
    });

    it("should not expose a model browser action", async () => {
      render(
        <TestWrapper>
          <FloatingActionBar />
        </TestWrapper>
      ...
      expect(mockSetModelSearchOpen).not.toHaveBeenCalled();
    });
  });
